...
def _guided_flow(context, frozen: dict[str, Any]) -> int:
    ...
    print()
    print("  * a balance-review workbook - LEAP compared with the ESTO or 9th")
    print("    balances, by flow and product, for the year(s) you choose;")
    ...
    print("  The workbook compares LEAP with the ESTO or 9th balances for the")
    print("  year(s) you name.")
