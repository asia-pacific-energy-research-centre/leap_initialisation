...
def _pyinstaller_spec(
    ...
    *,
    ...
    hidden = [
        ...
        "'codebase.portable_release.manifest'",
...
ENTRY_POINT_SOURCE = '''"""Frozen entry point. Generated by the release builder."""

import sys
from pathlib import Path

_HERE = Path(__file__).resolve().parent
for _name in sorted(p.name for p in _HERE.iterdir() if p.is_dir()):
...
def build(
    ...
    *,
    ...
    (code_root / "entry_point.py").write_text(ENTRY_POINT_SOURCE, encoding="utf-8")
