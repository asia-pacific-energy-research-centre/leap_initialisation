...
# Prefer active structural children of ``08 Transfers``. Keep this list complete
# even though LEAP allocation is by fuel function rather than child flow.
TRANSFER_SUBFLOWS = [
    "08.01 Recycled products",
    "08.02 Interproduct transfers",
    "08.03 Products transferred",
...
def select_transfer_flows(
    ...
    """Prefer active transfer children and fall back to the parent."""
    subflow_hits = []
