...
EXTRA_IMAGE_DIRS: list[Path] = [
    DOCS_DIR / "images",
    DOCS_DIR / "transformation_supply_docs",
    MERMAID_IMAGE_DIR,
]
...
COMBINED_OUTPUT_STEM = "LEAP Utilities Documentation"
COMBINED_FILES: list[Path] = [
    DOCS_DIR / "transformation_supply_docs" / "supply_reconciliation_workflow_guide.md",
]
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Override the docs directory to convert (default: DOCS_DIR from config)",
    )
