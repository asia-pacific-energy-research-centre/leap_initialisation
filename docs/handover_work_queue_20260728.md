...
| INITQ-015 | P1 | 1 | 2026-07-28 to 2026-08-03 | `complete_on_master` | init | — | Correct `AGENTS.md` | **Completed 2026-08-13; refreshed 2026-08-16.** Live parallel guidance names the implemented process runner and deterministic parent CSV families. Cross-economy workbook packaging has since been retired in both execution modes. | 2026-08-16 |
...
| INITQ-021 | P1 | 3 | 2026-08-11 to 2026-08-17 | `completed_retired` | init | user decision | Scope the single-file combined-workbook merge for parallel runs | **Completed 2026-08-16:** the user confirmed no cross-economy workbook is required for parallel or sequential execution. The unused parent merge and sequential single-file writer were removed. Per-economy seed workbooks and deterministic parent CSV diagnostics remain. | 2026-08-16 |
