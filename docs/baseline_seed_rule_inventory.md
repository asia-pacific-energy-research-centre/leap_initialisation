...
1. **Zero missing-ID reset exceptions.** CROSS-001 requires review, but no
   ...
   LEAP ID?
2. **Canonical scenario windows.** Workflows differ in Current Accounts and
...
3. **Refining capacity heuristic.** Legacy code derives Exogenous Capacity from
