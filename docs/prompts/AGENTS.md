...
| `full_initialisation_guide_creation.md` | Documentation consolidation; active | Builds one layered, modeller-led guide across clean-slate preparation, template export, seed generation, LEAP import/recalculation, review, issue routing, rule adjustment, and handover, with minimal code discussion. | Complete the source ledger first; treat supplied documents as evidence; keep the living rule-adjustment guide as a companion; approve Markdown content before creating the unbranded Word publication. |
