...
| `full_initialisation_guide_creation.md` | Documentation consolidation; placeholder for 2026-08-31 | Builds one modeller-facing guide across clean-slate preparation, template export, seed generation, LEAP import/recalculation, review, issue routing, rule adjustment, and handover. | Complete the source ledger first; treat supplied documents as evidence, verify conflicts against current code and accepted decisions, and agree the publication formats before authoring. |
