...
(codebase/transfers_workflow.py:648-650) and the SEED-012 check in
codebase/functions/supply_leap_io.py:1704-1718 has no tolerance for a legitimately-empty
producer. No fix was applied for either issue — they were left as design/mapping
