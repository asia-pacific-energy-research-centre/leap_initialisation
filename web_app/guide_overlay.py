...
() => {
  const steps = [
    ...
    { target: '#advanced-options, #esto-upload', title: 'Optionally change the ESTO comparison', copy: 'Open the optional ESTO area only when you have a different base table. It changes the comparison used by both outputs, and its latest year becomes the dashboard base year.', image: '' },
